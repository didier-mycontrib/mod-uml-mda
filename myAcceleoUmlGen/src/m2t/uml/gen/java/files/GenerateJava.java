 ...
 *******************************************************************************/
package m2t.uml.gen.java.files;
...
public class GenerateJava extends AbstractAcceleoGenerator {
   ...
   * @generated
   */
  public static final String MODULE_FILE_NAME = "/m2t/uml/gen/java/files/generateJava";
   ...
   * @generated
   */
  public static final String[] TEMPLATE_NAMES = { "generateJavaFile" };
  ...
  public List<String> getProperties() {
	    ...
	    //1 tenter de charger un eventuel fichier ".properties" dans le même répertoire que le model UML:
	    if (model != null && model.eResource() != null) { 
	        propertiesFiles.addAll(AcceleoEngineUtils.getPropertiesFilesNearModel(model.eResource()));
	    }
	    //2 utiliser default.properties dans src du projet acceleo (en plan B) :
	    propertiesFiles.add("default"); //default.properties
